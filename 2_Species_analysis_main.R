...
ggsave("../Figures/2_species/Evolution_hysteresis_competition.pdf", p_tot, width = 7, height = 7)
...
for (func_MF in c("normal","SGH")){
  for (scena in c("low_inter")){
    ...
    ggsave(paste0("../Figures/2_species/Net_effects_",scena,"_",func_MF,".pdf"),p_tot,width = 8,height = 5)
  }
}
...
ggsave("../Figures/2_species/Relative_recruitment_rate.pdf",p,width = 7,height = 5)
#at eq drho/dt = 0 ...
...
ggsave("../Figures/2_species/PA_scenarios_global_local.pdf",p_final,width = 14,height = 18)
...
p_final=ggarrange(p_tot_1,p_tot_2,p_tot_3,nrow=3,common.legend = T,legend = "bottom")
ggsave("../Figures/2_species/PA_strength_competition.pdf",p_final,width = 14,height = 18)
...
for (scena in c("low_inter","high_inter")[-2]){ 
  ...
  ggsave(paste0("../Figures/2_species/Net_effects_PA_",scena,"_global.pdf"),Pglob,width = 8,height = 5)
  ...
  ggsave(paste0("../Figures/2_species/Net_effects_PA_",scena,"_local.pdf"),Ploc,width = 8,height = 9)
  ...
  ggsave("../Figures/2_species/PA_qij.pdf",pq,width = 7,height = 4)
...
ggsave("../Figures/2_species/Varying_delta_CA.pdf", p, width = 13, height = 4, device = "pdf")
...
ggsave("../Figures/2_species/Clustering_figure_interspe.pdf", p_tot, width = 8, height = 6)




## 3) Same but along stress gradient for c21=3*c12 ----
...
# Step 5) Comparing Gillespie simulations with classical IBM  ----
rm(list = ls())
source("./2_Species_analysis_functions.R")
