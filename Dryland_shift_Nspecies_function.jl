using StatsBase, RCall, Plots, StatsPlots, Random, DifferentialEquations, LaTeXStrings,
    Images, Tables, CSV, LinearAlgebra, Distributions, DataFrames
...
function Get_classical_param_Nspecies(; N_species=4, type_interaction="classic", alpha_0=0.1, cintra=0.2, scenario_trait="spaced", h=1, trade_off=1)
